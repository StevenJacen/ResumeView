<template>
    <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
        <Table v-if="getziduan==true" :columns="columns11" :data="requireList" :table-header-color="tableHeaderColor" size="large" >
        </Table>
        <Table v-else :columns="columns10" :data="requireList" :table-header-color="tableHeaderColor" size="large" >
        </Table>
    </div>
</template>
